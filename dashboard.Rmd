...
### Temperatures and precipitation in 10 locations in NY 1981-2010
...
### Annual snowfall for 10 locations in NY 1981-2010
...
ny_noaa %>%
  ...
  mutate(location = fct_reorder(location, snow_total, .fun = median)) %>% 
